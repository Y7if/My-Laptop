...
//thunk for getting the posts messages
...
const postSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      //extra reducer for getting all the posts
      ...
      //extra reducer for like and dislike
